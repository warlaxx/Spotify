...
if (params.id<5) {
  ...
  useEffect(() => {
    fetch("http://localhost:3000/back/albums_All.php?data="+params.id)
      .then((res) => res.json())
      .then((result) => {
  ...
  return (
    <div>
      <Grid container spacing={2}>
        ...
        return <li style={{ cursor: "pointer", listStyle :"none" , margin: "5px" }} onClick = {() =>{navigate("/albumall/"+encodeURI(value))
